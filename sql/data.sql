...
-- Volcando datos para la tabla pruebamovies.wp_postmeta: ~65 rows (aproximadamente)
...
-- Volcando datos para la tabla pruebamovies.wp_posts: ~31 rows (aproximadamente)
